export const Items = {
  Breadboards: [
    ...
    {
      name: "Mini Breadboard (3 Pack)",
      image: "/mini-breadboard.jpg",
      affiliateLink: "https://www.amazon.com/dp/B08D9Z5L7L?tag=yourAffiliateID",
      price: null,
    },
    {
      name: "Breadboard with Power Supply Module",
      image: "/breadboard-power.jpg",
      affiliateLink: "https://www.amazon.com/dp/B08P3QV5JC?tag=yourAffiliateID",
      price: null,
    },
  ],
  Boards: [
  ...
  Sensors: [
    {
      ...
      affiliateLink: "https://www.amazon.com/dp/B07WXL5YPD?tag=yourAffiliateID",
      price: null,
    },
    {
      name: "Motion Sensor (HC-SR501)",
      image: "/motion-sensor.png",
      affiliateLink: "https://www.amazon.com/dp/B07XMZWPYT?tag=yourAffiliateID",
      price: null,
    },
    {
      name: "Light Sensor (LDR Module)",
      image: "/light-sensor.png",
      affiliateLink: "https://www.amazon.com/dp/B08T4V43D5?tag=yourAffiliateID",
      price: null,
    },
  ],
  Bonus: [
...
export const visualItems = [
  { item: "breadboard", image: "/raspberry-pi.png" },
  { item: "Usb", image: "usb.png" },
  { item: "cords", image: "usb.png" },
];
